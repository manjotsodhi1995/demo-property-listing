...
class Header extends Component {
  ...
  loopListings(properties) {
    if (
      typeof properties.filteredProperties !== "undefined" &&
            ...
            <div className="col-sm-12 col-md-6 col-lg-4 col-xl-3" key={index}>
              <div className="listing">
                <div
                  ...
                  style={{
                    background: `url("${property.image}") no-repeat center center`
                  }}
                >
                    ...
                    <div className="container">
                      ...
                      <div className="listing-details">
                        <div className="floor-space">
                          ...
                          <span>{property.floorSpace} ft&sup2;</span>
                        </div>
      ...
      <section id="listings" className="col-sm-12 col-md-12 col-lg-12">
        ...
        <section className="sortby-area">
          <div className="results">
            {this.props.globalState.filteredData.length} result found
          </div>
          <div className="sort-options">
            <select
              name="sortby"
              className="sortby"
              onChange={event => this.changeAscDesc(event, properties)}
            >
        ...
        <section className="listings-results">
          <div className="container">
            <div className="row">{this.loopListings(properties)}</div>
          </div>
        </section>
      </section>
    );
